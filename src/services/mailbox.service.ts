...
function toBackendMailboxPayload(payload: CreateMailboxRequest): CreateMailboxRequest {
  ...
  return {
    ...
    mailProvider: payload.mailProvider ?? 'OTHER',
    ...
    oauthClientId: cleanString(payload.oauthClientId),
    oauthClientSecret: cleanString(payload.oauthClientSecret),
    ...
    smtpStarttls: payload.smtpStarttls ?? null,
